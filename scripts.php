...
function prefix_frontend_scripts()
{
    ...
    wp_register_script('template-plugin-script', PREFIX_URL . 'assets/js/template-plugin' . $min . '.js', array('jquery'), '1.0.0', true);
    ...
    wp_enqueue_style('template-plugin-style', PREFIX_URL . 'assets/css/template-plugin.css', array(), false, 'all');
}
